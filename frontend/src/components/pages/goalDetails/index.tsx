...
export default function GoalDetails() {
  ...
  useEffect(() => {
    // Optionally, you can refetch the goal if goalId changes.
  }, [goalId]);
  ...
  return (
    <main className="flex flex-col">
      ...
      <section className="flex items-center gap-3">
        <div 
          className="w-full p-4 relative h-40 bg-muted rounded-lg flex flex-col items-center justify-center gap-2"
          style={{
